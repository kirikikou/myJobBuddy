...
function setResourceLevel(level) {
  ...
  loggingService.service('Parallelization', 'config-updated', {
    level: level,
    scrapers: newConfig.RESOURCE_LIMITS.MAX_CONCURRENT_SCRAPERS,
    parallel: newConfig.MAX_PARALLEL,
    preset: PRESETS[level].DESCRIPTION
  });
