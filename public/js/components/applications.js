(function() {
    ...
    function setupBulkActions() {
        ...
        if (clearAllDatesBtn) {
            clearAllDatesBtn.addEventListener('click', function() {
                console.log('Clear All Dates clicked');
        ...
        if (clearSelectedDatesBtn) {
            clearSelectedDatesBtn.addEventListener('click', function() {
                console.log('Clear Selected Dates clicked');
        ...
        if (clearAllFavoritesBtn) {
            clearAllFavoritesBtn.addEventListener('click', function() {
                console.log('Clear All Favorites clicked');
        ...
        if (clearSelectedFavoritesBtn) {
            clearSelectedFavoritesBtn.addEventListener('click', function() {
                console.log('Clear Selected Favorites clicked');
                if (selectedCompanies.size > 0) {
        ...
        if (clearAllBtn) {
            clearAllBtn.addEventListener('click', function() {
                console.log('Clear All Companies clicked');
    ...
    function saveNewCompany() {
        ...
        const name = newRow.querySelector('[data-field="name"]').value.trim();
        if (!name) {
        ...
        if (userData.companies[companyId]) {
            showToast('error', 'Company already exists');
            return;
        }

        const company = {
            name: name,
            location: newRow.querySelector('[data-field="location"]').value.trim(),
            selection: newRow.querySelector('[data-field="selection"]').value.trim(),
            website: '',
            linkedin: '',
            email: '',
            appliedDate: newRow.querySelector('[data-field="appliedDate"]').value,
            comments: null,
            favorite: newRow.querySelector('[data-field="favorite"]').classList.contains('active'),
            type: 'Company'
        };
    ...
    function populateCompaniesTable() {
        ...
        console.log(`Showing ${paginatedCompanies.length} companies out of ${filteredCompanies.length} total filtered companies`);
    }
    ...
    function openClearAllDatesModal() {
        ...
        if (modal) {
            console.log('Opening Clear All Dates Modal');
            modal.classList.add('show');
        } else {
            console.error('clear-all-dates-modal not found');
        }
    }
    ...
    function openClearSelectedDatesModal() {
        ...
        if (modal) {
            console.log('Opening Clear Selected Dates Modal');
            modal.classList.add('show');
        } else {
            console.error('clear-selected-dates-modal not found');
        }
    }   
    ...
    function openClearAllFavoritesModal() {
        ...
        if (modal) {
            console.log('Opening Clear All Favorites Modal');
            modal.classList.add('show');
        } else {
            console.error('clear-all-favorites-modal not found');
        }
    }
    ...
    function openClearSelectedFavoritesModal() {
        ...
        if (modal) {
            console.log('Opening Clear Selected Favorites Modal');
            modal.classList.add('show');
        } else {
            console.error('clear-selected-favorites-modal not found');
        }
    }
    ...
    function openClearAllCompaniesModal() {
        ...
        if (modal) {
            console.log('Opening Clear All Companies Modal');
            modal.classList.add('show');
        } else {
            console.error('clear-all-companies-modal not found');
        }
    }
    ...
    function openDeleteSelectedModal() {
        ...
        if (!modal) {
            console.error('delete-selected-modal not found');
            return;
        }
        ...
        console.log('Opening Delete Selected Modal');
        modal.classList.add('show');
    }
    ...
    function openCommentsModal(companyId) {
        console.log('Opening comments modal for company:', companyId);
        ...
        console.log('Form elements found:', { companyIdInput, titleInput, contentInput });
        ...
        console.log('Setting form values:', { title, content });
    ...
    function resetApplicationsViewAfterImport() {
        ...
        console.log('Applications view reset after import');
    }
    ...
    function setupCommentsModal() {
        ...
        const modal = document.getElementById('add-comments-modal');
        if (!modal) {
            console.error('Comments modal not found during setup');
            return;
        }
        console.log('Comments modal found:', modal);
        ...
        console.log('Modal buttons found:', { closeBtn, cancelBtn, saveBtn });
        ...
        function clearCommentsModal() {
            console.log('Clearing comments modal');
            const companyIdInput = document.getElementById('comments-company-id');
            const titleInput = document.getElementById('comments-title');
            const contentInput = document.getElementById('comments-content');
        ...
        if (saveBtn) {
            saveBtn.addEventListener('click', function() {
                console.log('Save comments button clicked');
                ...
                console.log('Data to save:', { companyId, title, content });
                ...
                console.log('Saving comments:', userData.companies[companyId].comments);
    ...
    window.safeSaveUserPreferences(userData);
        ...
        console.log('Comments modal setup complete');
    }
