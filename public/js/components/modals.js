(function() {
    ...
    function setupImportModal() {
        window.clientConfig&&window.clientConfig.smartLog('buffer','Setting up import modal...');
        const modal = document.getElementById('import-modal');
        if (!modal) {
            window.clientConfig&&window.clientConfig.smartLog('fail','Import modal not found');
            return;
        }
        ...
        window.clientConfig&&window.clientConfig.smartLog('buffer','Import modal setup starting');
        
        function resetImportModal() {
            window.clientConfig&&window.clientConfig.smartLog('buffer','Resetting import modal');
            csvData = null;
            columnMappings = {};
            isProcessing = false;
        ...
        if (closeBtn) {
            closeBtn.onclick = function() {
                window.clientConfig&&window.clientConfig.smartLog('buffer','Close import modal clicked');
                resetImportModal();
                modal.classList.remove('show');
            };
        }
        ...
        if (cancelImportBtn) {
            cancelImportBtn.onclick = function() {
                window.clientConfig&&window.clientConfig.smartLog('buffer','Cancel import clicked');
                resetImportModal();
                modal.classList.remove('show');
            };
        }
        ...
        if (uploadArea) {
            uploadArea.onclick = function() {
                window.clientConfig&&window.clientConfig.smartLog('buffer','Upload area clicked');
                const fileInput = document.getElementById('csv-file-input');
        ...
        if (fileInput) {
            fileInput.onchange = function(e) {
                window.clientConfig&&window.clientConfig.smartLog('buffer','File input changed');
        ...
        if (nextToMappingBtn) {
            nextToMappingBtn.onclick = function() {
                window.clientConfig&&window.clientConfig.smartLog('buffer','Next to mapping clicked');
        ...
        function handleFileUpload(file) {
            window.clientConfig&&window.clientConfig.smartLog('buffer','Handling file upload:', file.name);
            
            if (isProcessing) {
                window.clientConfig&&window.clientConfig.smartLog('buffer','Already processing, ignoring');
                return;
            }
            ...
            reader.onload = function(e) {
                window.clientConfig&&window.clientConfig.smartLog('buffer','File read successfully');
                try {
                    parseCsvData(e.target.result);
                } catch (error) {
                    window.clientConfig&&window.clientConfig.smartLog('fail','Error parsing CSV:', error);
            ...
            reader.onerror = function() {
                window.clientConfig&&window.clientConfig.smartLog('fail','File reader error');
                showToast('error', 'Error reading file');
                isProcessing = false;
            };
        ...
        function parseCsvData(csvText) {
            window.clientConfig&&window.clientConfig.smartLog('buffer','Parsing CSV data...');
            
            try {
                const lines = csvText.split('\n').filter(line => line.trim());
                window.clientConfig&&window.clientConfig.smartLog('buffer','Total lines found:', lines.length);
                ...
                window.clientConfig&&window.clientConfig.smartLog('buffer','Headers:', headers);
                ...
                window.clientConfig&&window.clientConfig.smartLog('buffer','CSV data parsed:', csvData.totalRows, 'total rows');
                ...
                window.clientConfig&&window.clientConfig.smartLog('fail','CSV parsing error:', error);
        ...
        function handleImportSubmit() {
            ...
            reader.onload = function(e) {
                try {
                    ...
                    window.clientConfig&&window.clientConfig.smartLog('fail','Error reading file:', error);
                    showToast('error', 'Error reading file');
                }
            };
            ...
            try {
                ...
                for (let i = 0; i < dataLines.length; i++) {
                    try {
                        ...
                        window.clientConfig&&window.clientConfig.smartLog('fail',`Error processing line ${i}:`, error);
                    }
                }
    ...
    window.safeSaveUserPreferences(userData);
                    ...
                    if (errors.length > 0 && errors.length <= 5) {
                        window.clientConfig&&window.clientConfig.smartLog('buffer','Import errors:', errors);
                    }
                } else {
        ...
        function displayCsvPreview() {
            window.clientConfig&&window.clientConfig.smartLog('buffer','Displaying CSV preview');
        ...
        function createMappingInterface() {
            window.clientConfig&&window.clientConfig.smartLog('buffer','Creating mapping interface');
        ...
        function updateMappingPreview() {
            window.clientConfig&&window.clientConfig.smartLog('buffer','Updating mapping preview');
        ...
        function generateImportPreview() {
            window.clientConfig&&window.clientConfig.smartLog('buffer','Generating import preview');
            ...
            window.clientConfig&&window.clientConfig.smartLog('buffer','Processing', rowsToProcess.length, 'rows for import');
            ...
            window.clientConfig&&window.clientConfig.smartLog('buffer','Generated', importableRows.length, 'importable companies');
        ...
        function performImport() {
            window.clientConfig&&window.clientConfig.smartLog('buffer','Performing import');
    ...
    window.safeSaveUserPreferences(userData);
                ...
                window.clientConfig&&window.clientConfig.smartLog('fail','Import error:', error);
        ...
        window.clientConfig&&window.clientConfig.smartLog('buffer','Import modal setup complete');
    }
    
    function openImportModal() {
        window.clientConfig&&window.clientConfig.smartLog('buffer','Opening import modal...');
        const modal = document.getElementById('import-modal');
        if (modal) {
            window.clientConfig&&window.clientConfig.smartLog('buffer','Modal found, showing...');
        ...
        if (copyCoverLetterBtn) {
            copyCoverLetterBtn.addEventListener('click', function() {
                ...
                navigator.clipboard.writeText(letter.content).then(() => {
                    ...
                    window.clientConfig&&window.clientConfig.smartLog('fail','Could not copy cover letter: ', err);
    ...
    function openAddApplicationModal(jobTitle, companyName, location, website, career) {
        window.clientConfig&&window.clientConfig.smartLog('buffer','openAddApplicationModal called with:', { jobTitle, companyName, location, website, career });
        
        const modal = document.getElementById('add-application-modal');
        window.clientConfig&&window.clientConfig.smartLog('buffer','Modal element found:', modal);
        
        if (!modal) {
            window.clientConfig&&window.clientConfig.smartLog('fail','Modal element not found!');
            return;
        }
        ...
        window.clientConfig&&window.clientConfig.smartLog('buffer','Form inputs found:', {
        ...
        window.clientConfig&&window.clientConfig.smartLog('buffer','About to show modal...');
        
        modal.classList.add('show');
        
        window.clientConfig&&window.clientConfig.smartLog('buffer','Modal classes after adding show:', modal.classList.toString());
        window.clientConfig&&window.clientConfig.smartLog('buffer','Modal should be visible now');
    }
