(function() {
    ...
    async function loadPricingData() {
        try {
            ...
            window.clientConfig&&window.clientConfig.smartLog('fail','Error loading pricing data:', error);
        }
    }
    ...
    async function initiateUpgrade(planName, duration) {
        try {
            ...
            window.clientConfig&&window.clientConfig.smartLog('fail','Upgrade error:', error);
