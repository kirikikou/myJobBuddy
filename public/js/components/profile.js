(function() {
        ...
        try {
            if (window.unifiedPreferencesService) {
                ...
                if (result) {
                    ...
                    showLocalizedToast('error', 'profile.saveError');
                }
            ...
            window.clientConfig && window.clientConfig.smartLog('fail', `Profile save error: ${error.message}`);
            showLocalizedToast('error', 'profile.saveError');
        }
    }
    ...
    function populateProfile() {
        if (!userData) {
            window.clientConfig && window.clientConfig.smartLog('buffer', 'populateProfile: userData not available, skipping');
            return;
        }
        ...
        window.clientConfig && window.clientConfig.smartLog('buffer', 'Profile populated from userData');
    }
