(function() {
    ...
    async function saveCoverLetter() {
        ...
        try {
            ...
            window.clientConfig&&window.clientConfig.smartLog('fail',"Error saving cover letter:", error);
    ...
    function populateCoverLetters() {
        ...
        try {
            ...
            window.clientConfig&&window.clientConfig.smartLog('fail',"Error reloading from localStorage:", e);
        }
