...
router.post('/register', isNotAuthenticated, async (req, res) => {
  try {
    ...
    loggingService.error('Registration error:',{ error: error });
    res.status(500).json({
      success: false,
...
router.post('/forgot-password', async (req, res) => {
  try {
    ...
    loggingService.error('Password reset error:',{ error: error });
    res.status(500).json({
      success: false,
...
router.put('/me', isAuthenticated, async (req, res) => {
  try {
    ...
    loggingService.error('Profile update error:',{ error: error });
    res.status(500).json({
      success: false,
...
router.put('/change-password', isAuthenticated, async (req, res) => {
  try {
    ...
    loggingService.error('Password change error:',{ error: error });
    res.status(500).json({
      success: false,
...
router.get('/google/callback', 
  ...
  async (req, res) => {
    try {
      ...
      loggingService.error('Google auth callback error:',{ error: error });
...
router.get('/linkedin/callback',
  ...
  async (req, res) => {
    try {
      ...
      loggingService.error('LinkedIn auth callback error:',{ error: error });
